    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
         ...
         Navigator.pushNamed(context, "funciones", arguments: creditCard);
          ...
          child: Container(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Text(
                  creditCard.accountNumber.toString().substring(0, 4) +
                      " " +
                      creditCard.accountNumber.toString().substring(4, 8) +
                      " " +
                      creditCard.accountNumber.toString().substring(8, 12) +
                      " " +
